    ...
    <div class="header__wrapper">
        <div class="header__logo-cont">
            <a class="header__logo" title="Kaspersky Lab"  href="#">
                <img class="header__logo-image" src="/theme/img/logo.png" alt="Kaspersky Lab" title="Kaspersky Lab">
            </a>
        </div>
        ...
        <div class="header__controls">
            ...
            if (Yii::$app->user->isGuest):
                ...
                <button id="go-1" class="header__login" title="логин">
                    <img class="header__login-image" src="/theme/img/icon_login.svg" alt="login" title="login">
...
<div class="footer">
    <div class="footer__wrapper">
        <img class="footer__cup" src="/theme/img/cup.png" alt="" title="">
        ...
        <div class="footer__social-link">
            <div class="socials">
                <a class="social-link" href="#"><img src="/theme/img/social_vk.svg"></a>
                <a class="social-link" href="#"><img src="/theme/img/social_f.svg"></a>
                <a class="social-link" href="#"><img src="/theme/img/social_twitter.svg"></a>
            </div>
        </div>
